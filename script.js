...
const translations = {
  en: {
    ...
    "源于军工航天底层机理，": "Rooted in the Fundamental Science of Defense and Aerospace,",
    "构建极限场景材料谱系。": "Building a Materials Spectrum for Extreme Environments.",
    ...
    "发现、验证、组合，让高科材料走向规模化交付。": "Discover, Validate and Combine Advanced Materials for Scalable Delivery.",
  ...
  ja: {
    ...
    "军工航天 · 国防科技高科材料池": "防衛・航空宇宙 · 先端材料プール", "汇聚高科材料，": "先端材料を集め、", "服务极限场景。": "極限環境に応える。", "源于军工航天底层机理，": "防衛・航空宇宙の基礎原理に根ざし、", "构建极限场景材料谱系。": "極限環境の材料体系を構築する。", "探索高科材料池": "先端材料プールを見る",
    "探索更多高科材料": "さらに先端材料を探る", "持续发现 · 引入 · 验证": "発見 · 導入 · 検証", "军工航天科技，为真实世界服务": "防衛・航空宇宙技術を実社会へ",
    "从军工航天技术源头，构建持续扩展的高科材料池。": "防衛・航空宇宙技術から、拡張し続ける先端材料プールへ。", "源于军工航天底层机理，构建极限场景材料谱系。": "防衛・航空宇宙の基礎原理に根ざし、極限環境の材料体系を構築する。", "发现、验证、组合，让高科材料走向规模化交付。": "先端材料を発見・検証・統合し、量産へつなげる。", "当前重点材料": "現在の重点材料",
  ...
  ko: {
    ...
    "军工航天 · 国防科技高科材料池": "방산·항공우주 · 첨단 소재 풀", "汇聚高科材料，": "첨단 소재를 모아,", "服务极限场景。": "극한 환경에 제공합니다.", "源于军工航天底层机理，": "방산·항공우주의 기초 원리에서 출발해,", "构建极限场景材料谱系。": "극한 환경을 위한 소재 체계를 구축합니다.", "探索高科材料池": "첨단 소재 풀 살펴보기",
    "探索更多高科材料": "더 많은 첨단 소재 탐색", "持续发现 · 引入 · 验证": "발굴 · 도입 · 검증", "军工航天科技，为真实世界服务": "방산·항공우주 기술을 현실 세계로",
    "从军工航天技术源头，构建持续扩展的高科材料池。": "방산·항공우주 기술에서 지속 확장되는 첨단 소재 풀로.", "源于军工航天底层机理，构建极限场景材料谱系。": "방산·항공우주의 기초 원리에서 출발해 극한 환경을 위한 소재 체계를 구축합니다.", "发现、验证、组合，让高科材料走向规模化交付。": "첨단 소재를 발굴하고 검증하며 결합해 규모화 공급으로 연결합니다.", "当前重点材料": "현재 핵심 소재",
