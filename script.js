...
const translations = {
  en: {
    ...
    "高性能材料": "High-Performance Materials",
  ...
  ja: {
    ...
    "产品": "製品", "行业": "産業分野", "技术平台": "技術プラットフォーム", "检测与标准": "試験・規格", "看人之大": "KRZD", "语言": "言語", "菜单": "メニュー",
    "联系专家": "専門家に相談", "材料科技": "材料科学", "全球标准交付": "グローバル規格で提供",
    ...
    "三种材料，无数种可能。": "3つの材料、無限の可能性。", "我们做什么": "事業分野",
  ...
  ko: {
    ...
    "产品": "제품", "行业": "산업", "技术平台": "기술 플랫폼", "检测与标准": "시험 및 표준", "看人之大": "KRZD", "语言": "언어", "菜单": "메뉴",
    "联系专家": "전문가 문의", "材料科技": "소재 과학", "全球标准交付": "글로벌 표준 공급",
    ...
    "三种材料，无数种可能。": "세 가지 소재, 무한한 가능성.", "我们做什么": "사업 분야",
...
function applyLanguage(language) {
  ...
  document.title = currentLanguage === "zh-CN" ? "看人之大 | 材料科技，应用于极限场景" : `KRZD | ${translateText("材料科技，应用于极限场景。")}`;
